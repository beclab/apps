...
{{- end -}}
{{- end -}}
{{- /* vllmgemma412bitawqint4v3.engineArgs: CPU mode auto-adds --device cpu unless already set.
       Usage: {{ include "vllmgemma412bitawqint4v3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "vllmgemma412bitawqint4v3.engineArgs" -}}
{{- $in := . -}}
