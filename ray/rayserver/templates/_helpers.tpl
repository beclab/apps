...
Common labels
*/}}
{{- define "rayserver.labels" -}}
app.kubernetes.io/name: {{ include "rayserver.name" . }}
helm.sh/chart: {{ include "rayserver.chart" . }}
...
{{- define "rayserver.deployment.name" -}}
{{- include "rayserver.fullname" . }}
{{- end -}}
...
{{- define "rayserver.service.name" -}}
{{- include "rayserver.fullname" . }}
{{- end -}}

{{- /* Create the name of the service account to use. */ -}}
{{- define "rayserver.serviceAccount.name" -}}
{{- if .Values.serviceAccount.create -}}
{{- default (include "rayserver.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- define "rayserver.clusterRole.name" -}}
{{- include "rayserver.fullname" . -}}
{{- end -}}

{{- /* Create the name of the cluster role binding to use. */ -}}
{{- define "rayserver.clusterRoleBinding.name" -}}
{{- include "rayserver.fullname" . -}}
{{- end -}}

{{- /* Create the name of the role to use. */ -}}
{{- define "rayserver.role.name" -}}
{{- include "rayserver.fullname" . -}}
{{- end -}}

{{- /* Create the name of the role binding to use. */ -}}
{{- define "rayserver.roleBinding.name" -}}
{{- include "rayserver.fullname" . -}}
{{- end -}}

{{- /* Create the name of the leader election role to use. */ -}}
{{- define "rayserver.leaderElectionRole.name" -}}
{{- include "rayserver.fullname" . -}}-leader-election
{{- end -}}

{{- /* Create the name of the leader election role binding to use. */ -}}
{{- define "rayserver.leaderElectionRoleBinding.name" -}}
{{- include "rayserver.fullname" . -}}-leader-election
{{- end -}}
