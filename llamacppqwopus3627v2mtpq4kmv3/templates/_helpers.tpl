...
{{- end -}}
{{- end -}}
{{- /* llamacppqwopus3627v2mtpq4kmv3.engineArgs: CPU mode auto-adds -ngl 0 unless user set -ngl.
       Usage: {{ include "llamacppqwopus3627v2mtpq4kmv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "llamacppqwopus3627v2mtpq4kmv3.engineArgs" -}}
{{- $in := . -}}
