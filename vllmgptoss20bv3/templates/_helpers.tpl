...
{{- end -}}
{{- end -}}
{{- /* vllmgptoss20bv3.engineArgs: CPU mode auto-adds --device cpu unless already set.
       Usage: {{ include "vllmgptoss20bv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "vllmgptoss20bv3.engineArgs" -}}
{{- $in := . -}}
