...
{{- end -}}
{{- end -}}
{{- /* llamacppornith35bggufv3.engineArgs: CPU mode auto-adds -ngl 0 unless user set -ngl.
       Usage: {{ include "llamacppornith35bggufv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "llamacppornith35bggufv3.engineArgs" -}}
{{- $in := . -}}
