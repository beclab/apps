...
{{- end -}}
{{- end -}}
{{- /* vllmornith9bggufv3.engineArgs: CPU mode auto-adds --device cpu unless already set.
       Usage: {{ include "vllmornith9bggufv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "vllmornith9bggufv3.engineArgs" -}}
{{- $in := . -}}
