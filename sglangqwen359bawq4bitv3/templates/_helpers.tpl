...
{{- end -}}
{{- end -}}
{{- /* sglangqwen359bawq4bitv3.engineArgs: CPU mode auto-adds --device cpu unless already set.
       Usage: {{ include "sglangqwen359bawq4bitv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "sglangqwen359bawq4bitv3.engineArgs" -}}
{{- $in := . -}}
