...
{{- end -}}
{{- end -}}
{{- /* ollamagemma426bv3.engineArgs: merge clone ENGINE_ARGS with chart defaults.
       ...
       Usage: {{ include "ollamagemma426bv3.engineArgs" (dict "Args" ($oe.ENGINE_ARGS | default "") "IsCpu" $isCpuMode) }} */ -}}
{{- define "ollamagemma426bv3.engineArgs" -}}
{{- $in := . -}}
...
{{- $args -}}
{{- end -}}
{{- /* ollamagemma426bv3.engineArgsForLlminit: user ENGINE_ARGS for llm-init only.
       ...
       Usage: {{ include "ollamagemma426bv3.engineArgsForLlminit" (dict "Args" ($oe.ENGINE_ARGS | default "") "IsCpu" $isCpuMode) }} */ -}}
{{- define "ollamagemma426bv3.engineArgsForLlminit" -}}
{{- $in := . -}}
{{- $args := trim ($in.Args | default "") -}}
{{- $isCpu := $in.IsCpu | default false -}}
