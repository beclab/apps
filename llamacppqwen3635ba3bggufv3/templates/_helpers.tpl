...
{{- end -}}
{{- end -}}
{{- /* llamacppqwen3635ba3bggufv3.engineArgs: CPU mode auto-adds -ngl 0 unless user set -ngl.
       Usage: {{ include "llamacppqwen3635ba3bggufv3.engineArgs" (dict "Args" $engineArgs "IsCpu" $isCpuMode) }} */ -}}
{{- define "llamacppqwen3635ba3bggufv3.engineArgs" -}}
{{- $in := . -}}
